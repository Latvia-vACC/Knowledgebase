...
<Callout type="error" emoji="⚠️">
  It is the ATCOs duty to use up to date software provided by the vACC. Use of
  outdated or improperly modified software constitutes lack of currency on the
  controller's behalf.
</Callout>
...
- **EVRR FIR Sector File** (AIRAC 2311) is the dataset used within EuroScope to provide ATC services in EVRR FIR.

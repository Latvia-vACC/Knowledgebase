...
The SIL can be used for non-verbal coordination with other controllers by requesting a non-default Coordinated Point of Entry (COPN) or Planned Entry Level (PEL). Such a request can be created by pressing <kbd>`LMB`</kbd> on the value of interest and inputting a new one.

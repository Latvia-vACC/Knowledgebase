...
### Flight Plan Creation[<span className="text-red-500 remove-parent-underline">\*</span>](#fp-visibility)
...
<br />
<span id="fp-visibility">
  <span className="text-red-500">\*</span> A flight plan created in such a way
  is **NOT** visible to adjacent ATCOs.
</span>

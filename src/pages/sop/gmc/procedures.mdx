...
- **4300 – 4377** for all international flights;
...
IFR departure clearances may be issued by datalink. All items of a datalink clearance must be thoroughly checked by the issuing ATCO. A short instruction on the use of the datalink is available in the [EuroScope Plugins Guide](/software-guides/euroscope/plugins).
...
Aircraft parked on the following stands are required/recommended to be pushed back onto taxiway W:
...
|    110, 111    |                                                      NIL                                                      |        Max. wingspan 36 m        |                              Stand next to the VIP terminal                               |

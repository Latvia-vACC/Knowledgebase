...
<PhraseologyDisplay>
  ...
  <span>
    ...
    to Stockholm-Arlanda via the LAPSA2H departure, squawk 4341.`
  </span>
  <span>
...
- Phraseology for correcting flight plan inaccuracies is not set in stone, though recommended examples are presented below.
...
<PhraseologyDisplay>
  ...
  <span>
    GMC: `BTI123, Riga Ground, I do not see a flight plan filed under your
    callsign, please file a flight plan.`
  </span>
  <span>BTI123: `Roger, BTI123.`</span>
</PhraseologyDisplay>
...
<PhraseologyDisplay>
  ...
  <span>
    GMC: `BTI123, Riga Ground, good evening, your requested flight level is
    invalid for your direction of flight, would you like FL320 or FL340?`
  </span>
  <span>BTI123: `FL320, BTI123.`</span>
  <span>
    GMC: `BTI123, (flight plan amended, )final FL320, report ready to copy IFR
    clearance.`
  </span>
</PhraseologyDisplay>

In cases when the filed flight plan cannot be deemed valid due to the lack of a critical flight plan item (aircraft type, route, etc.) the violating aircraft shall be prompted to refile the flight plan unless it can be corrected by altering the route. Recommended phraseology for both cases is shown below.
...
<PhraseologyDisplay>
  ...
  <span>
    GMC: `BTI123, Riga Ground, good evening, your filed flight plan is invalid(,{" "}
    {REASON}). Please refile.`
  </span>
  <span>BTI123: `Roger, BTI123.`</span>
</PhraseologyDisplay>
...
<PhraseologyDisplay>
  ...
  <span>
    GMC: `BTI123, Riga Ground, good evening, your filed flight plan is invalid,
    an alternative routing is available. Report ready to copy.`
  </span>
  <span>BTI123: `Ready to copy, BTI123.`</span>
  <span>
    GMC: `BTI123, information A is correct, cleared to Stockholm-Arlanda via the
    LAPSA2H departure, then DCT RASEL, after RASEL continue as filed, squawk
    4341.`
  </span>
  <span>
    BTI123: `Cleared to Stockholm-Arlanda via the LAPSA2H departure, DCT RASEL,
    continue as filed, squawk 4341, BTI123.`
  </span>
  <span>GMC: `BTI123, your readback is correct.`</span>
</PhraseologyDisplay>
...
<PhraseologyDisplay>
  ...
  <span>
    YLKGB: `cleared for right-hand visual circuit, runway 36, not below 1500FT,
    squawk 0060, YLKGB.`
  </span>
...
<PhraseologyDisplay>
  ...
  <span>
    ...
    the controlled airspace via KAGAL, remain at or below 1500FT, squawk 0060.`
  </span>
  <span>
    YLKGB: `cleared VFR departure to the north, runway 36, expect to exit the
    controlled airspace via KAGAL, remain at or below 1500FT, squawk 0060,
    YLKGB.`
  </span>
  <span>GMC: `YLKGB, Your readback is correct(, start-up approved).`</span>
</PhraseologyDisplay>
...
- In case when there is a queue of traffic forming on frequency, it is recommended to issue sequence numbers to traffic waiting, i.e.: `BTI123, stand by, number 2 for clearance.`

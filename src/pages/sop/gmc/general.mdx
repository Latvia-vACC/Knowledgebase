...
## Relevant Positions & Airspace

|        Callsign        |     Frequency     |       AoR        |     Lateral Limits     | Vertical Limits | Airspace Class |
| :--------------------: | :---------------: | :--------------: | :--------------------: | :-------------: | :------------: |
| Rīga Ground (EVRA_GND) | 118.805 (118.800) | RIX Rīga Airport | **EAST** of the runway |       N/A       |      NIL       |
...
## Responsibility & Required Knowledge
...
- To validate flight plans and issue flight clearances.
...
- To accommodate pilots' information or procedure requests.

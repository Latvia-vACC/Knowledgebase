...
| :------------------------------------------------------------------------------------------------------: | :-----------------------: | :-----------: | :-----------------------------------------------: | :----------------------------------------------: | :------------: |
|                                          Riga Tower (EVRA_TWR)                                           | 118.105 MHz (118.100 MHz) |   Riga CTR    | As defined in Republic of Latvia AIP EVRA AD 2.17 |                    SFC-2500FT                    |       C        |
| Lielvarde Tower (EVGA_TWR)[<span className="text-red-500 remove-parent-underline">\*</span>](#lielvarde) | 118.155 MHz (118.150 MHz) | Lielvarde CTR | As defined in Republic of Latvia AIP EVGA AD 2.17 | Sector A: SFC-1000FT<br/>Sector B: 1000FT-4000FT |       D        |
...
>
  ...
  as such is not a training airfield in Latvia vACC. Therefore this SOP will
  exclusively focus on procedures followed and phraseology used by Riga Tower.
  The majority of procedures are cross-applicable for both airfields. Additional
  details are available in the Republic of Latvia AIP and in the APS SOP.
</div>

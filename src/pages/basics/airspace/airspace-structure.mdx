...
Riga CTA is a class C airspace within the lateral limits of Riga FIR. It is staffed by Rīga Control and has vertical limits of `FL95-FL660` and is split into 3 AoR:

- Riga AoR – Sector NORTH (Rīga Control frequency 135.100 MHz)
- Riga AoR – Sector SOUTH (Rīga Control frequency 134.750 MHz / 135.100 MHz)
- Riga AoR – Sector EAST (Rīga Control frequency 133.200 MHz)

An additional secondary frequency is defined for all AoRs -- 134.125 MHz which is often used to combine sectors NORTH and SOUTH into a common sector (WEST) on the western side of the FIR. As in most European FIRs, the emergency frequency is 121.500 MHz.
...
- Rīga Information (120.225 MHz, all sectors)
- Rīga Approach (134.850 MHz, only sector 1)
- Rīga Approach (129.925 MHz, sectors 1, 2, and 5)
- Rīga Control (133.200 MHz, only sector 3)

...
- APS – Approach Control Surveilance
...
**Transfer and Visiting Controllers Policy (TVCP)** is a global VATSIM policy that governs members' attachments to different entities in the VATSIM administrative stucture and their status within them. In this section descriptions are provided to terms used within or relevant to the mentioned policy in the scope of Latvia vACC.

**Active Controllers** are those who are listed on the [Latvia vACC Controller Roster](https://lv-vacc.org/roster) and thus have the privelege to staff ATC positions within EVRR FIR.
...
**Visiting Controllers** are VATSIM members whose allocation is other than Latvia vACC who are listed on the [Latvia vACC Controller Roster](https://lv-vacc.org/roster) and thus have the privelege to staff ATC positions within EVRR FIR.

### Controller Endorsements

**Unrestricted Endorement** is one that is granted to a controller at the start of their training. This endorsement gives one the privilege of staffing ATC positions that are not designated as restricted. At the moment, no positions in Latvia vACC are restricted.

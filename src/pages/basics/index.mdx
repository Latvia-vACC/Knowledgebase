...
**Shall** in relation to an action or a requirement renders the action _mandatory_.

**Should** in relation to an action or a requirement renders the action _recommended_.

**May/Might** in relation to an action or a requirement renders the action _optional_.

...
Of course, there are many other weather conditions that may appear in a METAR, different types of clouds and additional data. While this example is enough to explain the general structure of a METAR, a full explanation with all other codes is available on [Wikipedia](https://en.wikipedia.org/wiki/METAR).
...
```. filename="SNOWTAM split into parts" /R18/ /93/ /91/ /6/ /9/
R18/6 9 93 91
```
